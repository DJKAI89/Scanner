  ...
  return (
    <div className={`card ${cls}`}>
      ...
      <div className="trade-setup">
        ...
        <div className="ts-box"><div className="ts-l">STOP LOSS</div><div className="ts-v dn">₹{fmt(p.sl)}</div><div className="ts-s dn">{slPct}%</div></div>
        <div className="ts-box"><div className="ts-l">TARGET</div><div className="ts-v up">₹{fmt(p.target)}</div><div className="ts-s up">{tgtPct?'+'+tgtPct+'%':''}</div></div>
      </div>
